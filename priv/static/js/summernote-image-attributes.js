  ...
  $.extend($.summernote.plugins, {
    'imageAttributes': function (context) {
      ...
      this.initialize = function () {
        ...
        // }
        // body += '</ul>' +
        var body = '<div class="ui form tab-content note-tab-content">';
        // Tab 1
        body += '' + //'  <div class="tab-pane note-tab-pane fade in active" id="note-imageAttributes' + timestamp + '">' +
          // '    <div class= form-group note-group-imageAttributes-url">' +
          ...
          // '      </div>' +
          // '    </div>' +
          '    <div class="field form-group note-group-imageAttributes-title">' +
          ...
          '      </div>' +
          '    </div>' +
          '    <div class="field form-group note-group-imageAttributes-caption">' +
          '      <label class="control-label note-form-label col-sm-3">' + lang.imageAttributes.caption + '</label>' +
          '      <div class="input-group note-input-group col-xs-12 col-sm-9">' +
          '        <input class="note-imageAttributes-caption form-control note-form-control note-input" type="text" />' +
          '      </div>' +
          '    </div>' +
          '    <div class="field form-group note-group-imageAttributes-alt">' +
          ...
          '      </div>' +
          '    </div>' +
          '    <div class="field form-group note-group-imageAttributes-dimensions">' +
          '      <label class="control-label note-form-label col-sm-3">' + lang.imageAttributes.dimensions + '</label>' +
          '      <div class="inline fields input-group note-input-group col-xs-12 col-sm-9">' +
          ...
          '  </div>';
        // Tab 2
        body += '' + //  <div class="tab-pane note-tab-pane" id="note-imageAttributes-attributes' + timestamp + '">' +
          '    <div class="field form-group note-group-imageAttributes-class">' +
          ...
          '      </div>' +
          '    </div>' +
          '    <div class="field form-group note-group-imageAttributes-style">' +
          ...
          '      </div>' +
          '    </div>';// +
        // '    <div class= form-group note-group-imageAttributes-role">' +
        ...
        if (false) {
          // Tab 3
          body += '  <div class="tab-pane note-tab-pane" id="note-imageAttributes-link' + timestamp + '">' +
            '    <div class= form-group note-group-imageAttributes-link-href">' +
            ...
            '      </div>' +
            '    </div>' +
            '    <div class= form-group note-group-imageAttributes-link-target">' +
            ...
            '    </div>' +
            '    <div class= form-group note-group-imageAttributes-link-class">' +
            ...
            '      </div>' +
            '    </div>' +
            '    <div class= form-group note-group-imageAttributes-link-style">' +
            ...
            '      </div>' +
            '    </div>' +
            '    <div class= form-group note-group-imageAttributes-link-rel">' +
            ...
            '    </div>' +
            // '    <div class= form-group note-group-imageAttributes-link-role">' +
      ...
      this.show = function () {
        ...
        var imgInfo = {
          ...
          caption: $($img).parent().is("figure") ? $($img).siblings().html() : null
        };
        if (imgInfo.caption) {
          imgInfo.class = $img.parent().attr('class');
          imgInfo.style = $img.parent().attr('style');
        }
        this.showImageAttributesDialog(imgInfo).then(function (imgInfo) {
          ...
          if (imgInfo.caption) {
            ...
            if (imgInfo.class == '') imgInfo.class = "Imagine-Image-With-Caption"
            $img.wrap(`<figure class="${imgInfo.class}" style="${imgInfo.style}"></figure>`)
            $img.after(`<figcaption>${imgInfo.caption}</figcaption>`)
            $img.attr('class', '');
            $img.attr('style', '');
          } else {
