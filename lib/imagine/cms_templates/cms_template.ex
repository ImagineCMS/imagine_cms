defmodule Imagine.CmsTemplates.CmsTemplate do
  ...
  @render_helpers "import Phoenix.HTML; import Phoenix.HTML.Form; use PhoenixHTMLHelpers; alias Imagine.{CmsPages, CmsPages.CmsPage}; import Kernel, only: [sigil_r: 2, sigil_s: 2, sigil_S: 2, if: 2, ==: 2, !=: 2, <: 2, <=: 2, >: 2, >=: 2, |>: 2, ||: 2, &&: 2];"
